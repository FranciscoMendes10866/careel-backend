...
import { update_email_policy, update_is_public_policy, update_password_policy, update_newsletter_policy, update_job_policy } from '@middlewares/account.policy'
...
router.put('/change_devices', auth_guard, update_job_policy ,change_devices)
router.get('/get_devices', auth_guard, update_job_policy ,get_devices)
