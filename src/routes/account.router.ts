...
import { change_email, change_is_public, change_password, change_newsletter, change_job, update_devices, get_devices } from '@controllers/account.controller'
...
router.put('/update_device/:id', auth_guard, update_devices_policy, update_devices)
